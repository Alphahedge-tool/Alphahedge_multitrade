...
// from a base32 secret. We store the user's Kotak TOTP secret and generate the
// code here, so the "Login with TOTP" flow needs no authenticator app at login
// time — it's fully automated, matching Angel/Upstox.
